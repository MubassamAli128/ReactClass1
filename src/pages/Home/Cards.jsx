...
const Cards=()=>{
    ...
    const CardData=[
        {
            CardLogo:<ImageBox cls='w-[50px] h-[50px] bg-orange-400 rounded-lg'>
        ...
        {
            CardLogo:<ImageBox cls='w-[50px] h-[50px] bg-blue-400 rounded-lg'>
        ...
        {
            CardLogo:<ImageBox cls='w-[50px] h-[50px] bg-green-400 rounded-lg'>
